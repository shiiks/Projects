...
<head>
  ...
  <title>Maps Services | RunStatics</title>
<style>
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="dashboard.jsp" class="brand-logo darken-1"><img src="<c:url value="/resources/images/1.png"/>" alt="materialize logo"></a> <span class="logo-text">Maps Service</span></h1></li>
                    </ul>

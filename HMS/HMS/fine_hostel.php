             ...
             <div class="body">
				<div id="welcome"> WELCOME <?php echo $data['name']; ?></div>
                    ...
                    <div>
						...
						<h3>FINE</h3>
                        <form id="allot" name="reg_student" method="post" action="fine_hostel1.php" style="padding-top:20px">
						...
						<tbody>
						<tr class="qbullet">
							<td class="qbullet" valign="top"><span class="style5">Description Of Fine.</span></td>
                                <td valign="top" width="3%"><div class="style5" align="center"><strong>:</strong></div></td>
								<td valign="top" width="56%">
                                    <span class="style5">
                                        <textarea rows=6  cols=40 name="fine" id="decs_fine"></textarea>
                                    </span>
                                </td>
						</tr>
						</tbody>

...
<html>
    <head>
            ...
            <title>HMS::SEARCH PASSOUT STUDENT BY NAME</title>
...
<script type="text/javascript">
                 ...
                 function getStuByName(){
                        ...
                        var url="retAliminiStuByName.php?id="+roll;
					...
					{
			        location='CstuDetAlumini.php?roll='+val;
										}
			...
			$query = 'active';
             ...
             <div class="body">
				<div id="welcome"> WELCOME <?php echo $data['name']; ?></div>
                    <div class="featured"> 
                  <h3>Search Student By Name or Roll</h3>
                   <table width="100%" cellpadding="10" cellpadding="10" align="center">
                   <tr>
                   <td align="center">Enter Name or Roll No:

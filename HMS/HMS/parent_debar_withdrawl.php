             ...
             <div class="body">
				<div id="welcome"> WELCOME <?php echo $data['name']; ?></div>
                    ...
                    <div>
                        ...
                        <form action="parent_uploads.php" method="POST" enctype="multipart/form-data" style="padding-top:20px">
                        <table width="800" border="0" align="center">
                        <tbody>
                            <tr class="qbullet">
                                <td class="qbullet" valign="top"><span class="style5">Parent Consent</span></td>

             ...
             <div class="body">
				<div id="welcome"> WELCOME <?php echo $data['name']; ?></div>
                    ...
                    <div>
                        ...
                        <form action="uploads.php" method="POST" enctype="multipart/form-data" style="padding-top:20px">
                        <table width="800" border="0" align="center">
                        <tbody>
                            <tr class="qbullet">
                                <td class="qbullet" valign="top"><span class="style5">Money Reciept</span></td>
						...
						<form action="uploads1.php" method="POST" enctype="multipart/form-data" style="padding-top:20px">
                        <table width="800" border="0" align="center">
                        <tbody>
                            <tr class="qbullet">
                                <td class="qbullet" valign="top"><span class="style5">Application Of Student</span></td>
                                <td valign="top" width="3%"><div class="style5" align="center"><strong>:</strong></div></td>
                                <td valign="top" width="56%">
                                    <span class="style5">
                                        <input type="file" name="fileToUpload" id="fileToUpload"/>

             ...
             <div class="body">
				<div id="welcome"> WELCOME <?php echo $data['name']; ?></div>
                    ...
                    <div>
						...
						<h3>Decision</h3>
						<form method="POST" action="decision2.php">
						...
						Dc Action:<textarea name="dc_action"></textarea><br><br>
						<input type="submit" name="submit" value="Submit"/>
						</form>
						<?php
							if(isset($_POST['submit']))
							{
									if(!empty($_POST['dc_action']))
									{
										$query9="INSERT INTO indisciplinary_dc_reports (dc_action) VALUES ('".$POST['dc_action']."') WHERE Ticket_no='".$_SESSION['Ticket_no']."'";

	...
	public function messages(){
		...
		foreach ($messages as $message) {
			...
			$chat = array(
				...
				'name'		=> $message->from == $user ? 'You' : ucwords($owner->country)
				);
		...
		$contact = array(
			'name'=>ucwords($chatbuddy->country),
	...
	public function save_message(){
		...
		if($message != '' && $buddy != '')
		{
			...
			$chat = array(
				...
				'name'		=> $msg->from == $logged_user ? 'You' : ucwords($owner->country)
				);
	    ...
	    if ($new_exists) {
			...
			foreach ($new_messages as $message) {
				...
				$chat = array(
					...
					'name'		=> $message->from == $user_id ? 'You' : ucwords($owner->country)
					);
				array_push($thread, $chat);
			}

    ...
    a.fn.bxSlider = function (b) {
        ...
        function H() {
            ...
            if (b.mode == "horizontal") {
                ...
                e.wrap('<div class="' + b.wrapperClass + '" style=" position:relative;"></div>').wrap('<div class="bx-window" style="height:' + m + 'px; position:relative; overflow:hidden;"></div>').css({
                    height: "999999px",
                    position: "relative",
                    top: "-" + z + "px"
                });
                ...
                e.wrap('<div class="' + b.wrapperClass + '" position:relative;"></div>').wrap('<div class="bx-window" style="height:' + w + "px; width:" + v + 'px; position:relative; overflow:hidden;"></div>');
